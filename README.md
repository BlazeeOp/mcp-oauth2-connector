...
- 🛡️ **Comprehensive security** with rate limiting, input validation, and secure headers
- 🔧 **Individual tool files** for easy extension
- 📝 **Context management** (create, retrieve contexts)
...
│       │   ├── rate_limiting.py # Rate limiting protection
│       │   └── security.py      # Security headers and validation
│       ├── tools/               # MCP tools (echo, add, etc.)
